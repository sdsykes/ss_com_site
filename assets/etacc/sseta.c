/*
    This ETA interpreter is part of the ETA C Compiler project by Stephen Sykes

    Copyright (C) 2002-2003  Stephen Sykes
...
#define MAXLINES 2      /* times 64k */
#define MAXCHARS 20     /* times 64k */
...
void loadprogram(char *f) {
  ...
  if (verbose) fprintf(stderr, "ETA reading source\n");
...
void runprogram() {
 ...
 if (verbose) fprintf(stderr, "ETA initilising stack\n");

 initstack();

 if (verbose) fprintf(stderr, "ETA running eta code\n");
